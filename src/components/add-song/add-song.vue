    ...
    <div class="add-song" v-show="showFlag" @click.stop>
      ...
      <div class="shortcut" v-show="!query">
        ...
        <div class="scroll-wrapper">
          <cube-scroll ref="songList" :refreshDelay="100" v-if="currentIndex === 0" :data="playHistory" class="list-scroll">
            <div class="list-inner">
              <song-list :songs="playHistory" @select="selectSong"></song-list>
            </div>
          </cube-scroll>
          <cube-scroll ref="searchList" :refreshDelay="100" v-if="currentIndex === 1" :data="searchHistory" class="list-scroll">
            <div class="list-inner">
